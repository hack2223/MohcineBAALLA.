...
public class BookManager {
	...
	public int addBook(Book b) {
		...
		try {
			...
			nb = dataBase.editer("insert into books (name, categorie, author) values('" + b.getName() + "', '"
	...
	public int deleteBook(int id) {
		...
		try {
			dataBase.seconnecter();
			nb = dataBase.editer("delete from books where id=" + id);
			dataBase.sedeconnecter();
		} catch (ClassNotFoundException | SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public int addBookFromStudent(int student_id ,int book_id) {
		...
		try {
			dataBase.seconnecter();
			nb = dataBase.editer("update books set student_id = "+student_id+" where id=" + book_id);
			dataBase.sedeconnecter();
		} catch (ClassNotFoundException | SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public int returnBookToBiblio(int id) {
		...
		try {
			dataBase.seconnecter();
			nb = dataBase.editer("update books set student_id = "+null+" where id=" + id);
			dataBase.sedeconnecter();
		} catch (ClassNotFoundException | SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
